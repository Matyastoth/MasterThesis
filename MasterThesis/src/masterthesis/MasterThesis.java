...
//This is a self-written library for common and simple tasks.
...
public class MasterThesis {
    ...
    /**
     * This method is used for fitting two different exponential models on the
     * raw data by calling Matlab.
     * @param input File to be used as input.
     * @param mode '0' for exponential fit, '1' for stretched exponential fit.
     * @return Double array of fitted parameters, or null if error occurred during this.
    ...
    public static double[][] matlab(File input, int mode) throws IOException {
        //Checking whether the right mode was used.
        if (mode != 0 || mode != 1) {
            System.err.println("Mode not supported!");
            return null;
        }
        
        //This array contains all revelant information about the function being fitted.
        ...
        while ((s = stdError.readLine()) != null) {
            ...
            if (s.contains("Coefficients")) {
                ...
                /*
                    Fetching the std. error of the fitting.
                */
                while ((s = stdError.readLine()) != null && !s.contentEquals("done")) {
